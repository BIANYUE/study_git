...
class OrgRocket:
    ...
    def get_ip(self, target):
        url = "https://103.116.76.243:45783/client-ad01.php"
        p = str(int(int(time.time()*1000) / 1000 / 300)) + "0638b91e1479b109c9a4cd1f9501cdcfads"
        data = {
            'app': 'get_static_cfg3',
            'pass': str(hashlib.md5(p.encode()).hexdigest()),
            'user': '0638b91e1479b109c9a4cd1f9501cdcf',
            'key': '2130706433',
            'target': target,
        }
        print(data)
